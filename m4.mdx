...
---- | ---- | ----------- | -------
`directory` | <code>[str](#str)</code> | Directory path to download dataset. | *required*
`group` | <code>[str](#str)</code> | Name of the group to download. If None, downloads all.
...
Type | Description
---- | -----------
<code>[Tuple](#typing.Tuple)\[[DataFrame](#pandas.DataFrame), [Optional](#typing.Optional)\[[DataFrame](#pandas.DataFrame)\], [Optional](#typing.Optional)\[[DataFrame](#pandas.DataFrame)\]\]</code> | Tuple\[pd.DataFrame, Optional[pd.DataFrame], Optional[pd.DataFrame]\]:
...
Allowed groups: 'Yearly', 'Quarterly', 'Monthly',
'Weekly', 'Daily', 'Hourly'. | *required*
`y_hat` | <code>[Union](#typing.Union)\[[ndarray](#numpy.ndarray), [str](#str)\]</code> | Group forecasts as numpy array or
benchmark url from
https://github.com/Nixtla/m4-forecasts/tree/master/forecasts. | *required*
...
If `None` returns Naive2. | <code>None</code>
