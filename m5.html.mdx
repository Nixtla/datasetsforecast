...
---- | ---- | ----------- | -------
`directory` | <code>[str](#str)</code> | Directory where data will be downloaded. | *required*
`validation` | <code>[bool](#bool)</code> | Whether perform validation evaluation. Default False, return test evaluation. | <code>False</code>
...
Type | Description
---- | -----------
<code>[DataFrame](#pandas.DataFrame)</code> | pd.DataFrame: DataFrame with column wrmsse and Level_id (plus a 'Total' row) as index.
...
`validation` | <code>[bool](#bool)</code> | Whether return validation forecasts. Default False, return test forecasts. | <code>False</code>
